...
from apps.debriefings.models import Debrief
from django.db.models.signals import post_save
from django.dispatch import receiver


@receiver(
    post_save, sender=Debrief, dispatch_uid="debrief_create_complete_camunda_task"
)
def complete_camunda_task_create_debrief(sender, instance, created, **kwargs):
    ...
    CamundaService().complete_task(task["id"], {"violation": {"value": "true"}})
