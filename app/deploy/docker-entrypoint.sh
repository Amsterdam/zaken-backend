...
python manage.py shell -c "from django.db import connection; cursor = connection.cursor(); cursor.execute('drop schema public cascade; create schema public;'); cursor.close();"
