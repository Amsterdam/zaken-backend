...
from apps.camunda.views import (
    CamundaProcessViewSet,
    CamundaTaskViewSet,
    CamundaWorkerViewSet,
)
...
router.register(r"camunda/process", CamundaProcessViewSet, basename="camunda-processes")
